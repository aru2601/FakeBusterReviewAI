...
/* ══════════════════════════════════════════
   ...
   No UI/UX or functionality changes
   ══════════════════════════════════════════ */
...
@media (max-width:768px){{
    .hero{{padding:28px 1rem 20px!important}}
    .hero-title{{font-size:2.4rem!important;letter-spacing:.02em!important}}
    .hero-sub{{font-size:.58rem!important;letter-spacing:.08em!important;padding:0 .5rem}}
    .topbar{{padding:10px 1rem!important}}
    .tb-brand{{font-size:.9rem!important}}
    .tb-sub{{font-size:.48rem!important;letter-spacing:.06em!important}}
    .spotlight{{padding:18px 14px!important;border-radius:16px!important;margin:0 0 18px!important}}
    .rcard{{padding:16px 14px!important;border-radius:14px!important;margin:0 0 14px!important}}
    .vfake h2,.vreal h2{{font-size:1.25rem!important}}
    .mprow{{gap:6px!important}}
    .mp{{min-width:76px!important;padding:6px 8px!important}}
    .mp-v{{font-size:.88rem!important}}
    .mp-l{{font-size:.46rem!important}}
    .krow{{grid-template-columns:1fr 1fr!important;margin:0 0 14px!important}}
    .kc{{border-right:none!important;border-bottom:1px solid {CB}!important}}
    .kc:nth-child(odd){{border-right:1px solid {CB}!important}}
    .kc:last-child{{border-bottom:none!important}}
    .kc-v{{font-size:1.15rem!important}}
    .dash-grid{{grid-template-columns:1fr!important;padding:0!important;gap:10px!important}}
    .dash-card,.dash-card-full{{padding:14px!important;border-radius:14px!important;margin:0 0 10px!important}}
    .cw{{flex-direction:column!important;padding:0!important;gap:10px!important}}
    .cloud{{max-width:100%!important;min-width:unset!important;width:100%!important;border-radius:14px 14px 14px 4px!important}}
    .sdiv{{padding:0!important;margin:22px 0 12px!important}}
    .sdiv-title{{font-size:.7rem!important;letter-spacing:.07em!important}}
    .pill{{font-size:.72rem!important;padding:5px 10px!important}}
    .stButton>button{{font-size:.82rem!important;padding:10px 14px!important}}
}}

@media (max-width:480px){{
    .hero-title{{font-size:1.8rem!important}}
    .hero-sub{{font-size:.52rem!important}}
    .kc-v{{font-size:.95rem!important}}
    .vfake h2,.vreal h2{{font-size:1rem!important}}
    .mp{{min-width:64px!important;padding:5px 7px!important}}
    .mp-v{{font-size:.78rem!important}}
    .spotlight,.rcard{{padding:12px 10px!important}}
}}
